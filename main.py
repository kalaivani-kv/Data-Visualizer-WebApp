...
if selected_file:
    ...
    # Read the selected CSV file as a pandas Dataframe
    ...
    with col2:
        ...
        #For distribution plot if we need one column we use ["None"]
        ...
        plot_type = st.selectbox("Select the type of plot", options=plot_list, index=None)
